...
namespace Task6_2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Order_ID,Customer_ID,Order_Date")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Order_ID,Customer_ID,Order_Date")] Order order)
        {
            if (ModelState.IsValid)
            {
