...
namespace _2_2Task.Controllers
{
    public class EmployeeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,First_Name,Last_Nama,Email,Phone,Age,Job_Title,Gender")] Employeee employeee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,First_Name,Last_Nama,Email,Phone,Age,Job_Title,Gender")] Employeee employeee)
        {
            if (ModelState.IsValid)
            {
